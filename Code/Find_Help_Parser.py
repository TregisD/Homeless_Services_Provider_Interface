...
folder_path = '../Leo/LA/LA_Mental_Health_HTML_Files'
...
csv_filename = "FindHelp_extracted_data_la_mental_health.csv"
...
# Load the main data
df = pd.read_csv("FindHelp_extracted_data_la_mental_health.csv")
...
filtered_df.to_csv("FindHelp_extracted_data_la_mental_health.csv", index=False, encoding='utf-8')
